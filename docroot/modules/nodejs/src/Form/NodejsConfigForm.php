...
class NodejsConfigForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['server'] = array(
      '#type' => 'fieldset',
      '#title' => t('Node.js Drupal settings'),
    );
    $form['server']['scheme'] = array(
      '#type' => 'radios',
      '#title' => t('Drupal to Node.js server protocol'),
      '#default_value' => $config->get('nodejs.scheme'),
      '#options' => array('http' => t('http'), 'https' => t('https')),
      '#description' => t('The protocol used to communicate with the Node.js server from Drupal PHP code.'),
    );
    ...
    $form['server']['client_scheme'] = array(
      '#type' => 'radios',
      '#title' => t('Client javascript to Node.js server protocol'),
      '#default_value' => $config->get('client.scheme'),
      '#options' => array('http' => t('http'), 'https' => t('https')),
      '#description' => t('The protocol used to communicate with the Node.js server from client javascript code.'),
    );
    $form['server']['client_host'] = array(
      '#type' => 'textfield',
      '#title' => t('Node.js server host for client javascript.'),
    ...
    $form['server']['client_port'] = array(
      '#type' => 'textfield',
      '#title' => t('Node.js server port for client javacript'),
